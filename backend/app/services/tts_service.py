...
class TTSService:
    ...
    async def generate_speech(
        ...
        *,
        ...
        """Generate speech from text with context-aware voice routing."""

        normalized_text = text.strip()
        try:
            routed_context = self._context_router.resolve(
        ...
        resolved_voice_id = routed_context.backend_voice_id
        response_voice_id = routed_context.voice_profile.voice_id
            ...
            try:
                ...
                logger.info(
                    ...
                    extra={
                        ...
                        "tts_mode": routed_context.context.mode,
                        "is_narration": routed_context.context.is_narration,
                        "route_reason": routed_context.route_reason,
                    },
                )
                return result
            except TimeoutError:
