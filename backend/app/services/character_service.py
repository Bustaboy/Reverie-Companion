...
class CharacterNotFoundError(KeyError):
    ...
    user_message = (
        ...
        "Want to create a new one together? 💕"
    )
...
class CharacterPromptCompiler:
    ...
    def compile(self, blueprint: CharacterBlueprint) -> str:
        ...
        # roleplay-integrity block so character prompts preserve adult-fiction
        # immersion while still honoring OOC stops, distress, and hard safety lines.
