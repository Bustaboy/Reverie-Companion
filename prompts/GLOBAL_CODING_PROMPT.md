...
- **Self-reflection/journal work**: Load `https://github.com/Bustaboy/Reverie-Companion/blob/main/prompts/skills/self-reflection-journal.md` for `ReflectionManager`, `trigger_reflection`, journal entry schemas, first-person reflection prose, reflection-memory promotion decisions, evidence scoring, privacy tags, rollback metadata, or any feature that turns conversations into journaled character growth artifacts.
