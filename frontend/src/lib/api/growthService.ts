...
export class GrowthService {
  ...
  evaluateAutoTraining(): Promise<LoRATrainingJob | null> {
    return this.request<PersonalLoRAJobResponse>('/growth/personal-lora/evaluate-auto', { method: 'POST' }).then(
      (response) => response.job ?? null
    );
  }
